...
class Organization(Thing):
    ...
    type_: str = Field(default="Organization", alias="@type", Literal=True)
    ...
    memberOf: Optional[
        Union[
            List[Union["MemberProgramTier", "ProgramMembership", "Organization", str]],
            "MemberProgramTier",
            "ProgramMembership",
            "Organization",
            str,
    ...
    owns: Optional[
        Union[
            List[Union["Product", "OwnershipInfo", str]],
            "Product",
            "OwnershipInfo",
            str,
        ]
    ...
    serviceArea: Optional[
        Union[
            List[Union["Place", "AdministrativeArea", "GeoShape", str]],
            "Place",
            "AdministrativeArea",
            "GeoShape",
            str,
    ...
    acceptedPaymentMethod: Optional[
        Union[
            List[Union["LoanOrCredit", "PaymentMethod", str]],
            "LoanOrCredit",
            "PaymentMethod",
            str,
        ]
    ...
    areaServed: Optional[
        Union[
            List[Union[str, "Text", "Place", "AdministrativeArea", "GeoShape"]],
            str,
            "Text",
            "Place",
            "AdministrativeArea",
