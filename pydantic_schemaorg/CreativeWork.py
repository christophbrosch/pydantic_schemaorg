...
class CreativeWork(Thing):
    ...
    type_: str = Field(default="CreativeWork", alias="@type", Literal=True)
    ...
    size: Optional[
        Union[
            List[
                Union[
                    str, "Text", "QuantitativeValue", "SizeSpecification", "DefinedTerm"
                ]
            ],
            str,
            "Text",
...
if TYPE_CHECKING:
    ...
    from pydantic_schemaorg.IPTCDigitalSourceEnumeration import (
        IPTCDigitalSourceEnumeration,
    )
